...
public class LsasOutroFragment extends Fragment {
    private static final String ARG_MESSAGE = "arg_message";
    private String mMessage;

    public LsasOutroFragment() {
    }

    public static LsasOutroFragment newInstance(String message) {
        LsasOutroFragment fragment = new LsasOutroFragment();
